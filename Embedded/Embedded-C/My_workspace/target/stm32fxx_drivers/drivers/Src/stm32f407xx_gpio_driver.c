...
void GPIO_Init(GPIO_Handle_t *pGPIOHandle)
{
	...
	}else
	{
		...
		}else if (pGPIOHandle->GPIO_PinConfig.GPIO_PinMode == GPIO_MODE_INPUT_RISING_FALLING_EDGE_TRIGGER )
		{
		...
		uint8_t SYSCFG_EXTICRNumber = pGPIOHandle->GPIO_PinConfig.GPIO_PinNumber / 4 ;
		uint8_t bitInSYSCFG_EXTICR = pGPIOHandle->GPIO_PinConfig.GPIO_PinNumber % 4;
		uint8_t portcode = GPIO_BASEADDR_TO_CODE(pGPIOHandle->pGPIOx);
		SYSCFG_PCLK_EN();
		SYSCFG->EXTICR[SYSCFG_EXTICRNumber] = portcode << ( bitInSYSCFG_EXTICR * 4);
 ...
 * @Note              -
 */
void GPIO_DeInit(GPIO_RegisterDefinition_t *pGPIOx)
{
 ...
 * @Note              -
 */
uint8_t GPIO_ReadFromInputPin(GPIO_RegisterDefinition_t *pGPIOx, uint8_t PinNumber)
{
   uint8_t value;
 ...
 * @Note              -
 */
uint16_t GPIO_ReadFromInputPort(GPIO_RegisterDefinition_t *pGPIOx)
{
	uint16_t value;
 ...
 * @Note              -
 */
void GPIO_WriteToOutputPin(GPIO_RegisterDefinition_t *pGPIOx, uint8_t PinNumber, uint8_t Value)
{
 ...
 * @Note              -
 */
void GPIO_WriteToOutputPort(GPIO_RegisterDefinition_t *pGPIOx, uint16_t Value)
{
	pGPIOx->ODR  = Value;
}
 ...
 * @Note              -
 */
void GPIO_ToggleOutputPin(GPIO_RegisterDefinition_t *pGPIOx, uint8_t PinNumber)
{
	pGPIOx->ODR  ^= ( 1 << PinNumber);
}
