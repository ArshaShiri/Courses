 ...
 * <p>
 * he union–find data type models connectivity among a set of <em>n</em>
 * ites, named 0 through <em>n</em>–1.
 * he <em>is-connected-to</em> relation must be an
...
public class QuickFindUF {
     ...
     * if the sites are in different components, merge5 the two components
